...
// Replace affective-engine, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= affective-engine — Quick Start for Users
:toc:
:toclevels: 2

== What is affective-engine?
...
[source,bash]
----
just install --portable --prefix=./affective-engine-portable
----
...
* **Wiki**: https://github.com/metadatastician/affective-engine/wiki
