...
Jonathan D.A. Jewell (metadatastician) <jonathan.jewell@gmail.com>
:toc:
:sectnums:
...
Use the template at TOPOLOGY.md in affective-engine as a structural reference,
...
[source,bash]
----
cp /path/to/affective-engine/TOPOLOGY.md ./TOPOLOGY.md
