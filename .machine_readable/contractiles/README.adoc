...
= Enaction Engine Contractiles
:toc:
:sectnums:

This directory contains Enaction Engine's project-specific RSR contractiles.
Their structure follows the estate standards; their declared invariants,
failure modes, intent, and cleanup posture belong to this engine.
