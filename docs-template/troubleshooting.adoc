...
= Troubleshooting — Enaction Engine
:revdate: 2026-MM-DD
...
. For *security*-relevant findings, see
  link:../.github/SECURITY.md[security policy] — do **not** file public issues.

== Where to look for more help

* `docs/architecture.adoc` — internals.
* `docs/decisions/` — historical record of why things are this shape.
* `https://github.com/metadatastician/enaction-engine/issues?q=is%3Aissue+<your symptom>` — has anyone hit this before?
