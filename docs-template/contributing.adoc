...
= Contributing — Enaction Engine
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Enaction Engine`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/enaction-engine.git
cd enaction-engine
...
* Bugs in `Enaction Engine`: file at `metadatastician/enaction-engine/issues`.
