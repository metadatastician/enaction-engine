...
// SPDX-FileCopyrightText: 2026 Jonathan D.A. Jewell (metadatastician) <jonathan.jewell@gmail.com>
= Contributing — Affective Engine
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Affective Engine`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/Affective Engine.git
cd Affective Engine
...
* Bugs in `Affective Engine`: file at `metadatastician/Affective Engine/issues`.
