...
project := "affective-engine"
OWNER := "metadatastician"
REPO := "affective-engine"
version := "0.1.0"
...
build *args:
    @echo "Building affective_engine (debug)..."
...
build-release *args:
    @echo "Building affective_engine (release)..."
...
install: build-release
    @echo "Installing affective_engine..."
...
cookbook:
    ...
    echo "= affective_engine Justfile Cookbook" > "$OUTPUT"
...
man:
    #!/usr/bin/env bash
    mkdir -p docs/man
    cat > docs/man/affective_engine.1 << EOF
    .TH affective_engine 1 "$(date +%Y-%m-%d)" "{{version}}" "affective_engine Manual"
    .SH NAME
    affective_engine \- RSR-compliant project
    .SH SYNOPSIS
    .B just
    [recipe] [args...]
    .SH DESCRIPTION
    ...
    EOF
    echo "Generated: docs/man/affective_engine.1"
...
doctor:
    @echo "Running diagnostics for affective-engine..."
...
help-me:
    @echo "=== affective-engine Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/metadatastician/affective-engine/issues/new"
    @echo ""
