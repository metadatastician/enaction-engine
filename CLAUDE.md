...
# This repo: `affective-engine`  ·  clade `rm-affective-engine`

- **Identity** — uuid `a5ea1382-a34c-5334-8a46-a2ebe904c810`; clade `rm` (secondary `gv`); born 2026-03-16; forge `metadatastician/affective-engine`.
...
- **Where it sits** — pipeline position **foundation**; chain `standards → affective-engine → (every estate repo)`; coordination = `standards`.
