...
# @a2ml-metadata begin
# (
#   id                   = "enaction-engine-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "enaction-engine"
#   app-display          = "Enaction Engine"
#   app-url              = ""
...
#
# ============================================================================
# enaction-engine-launcher.sh — Enaction Engine
# ============================================================================
# GENERATED by launch-scaffolder from enaction-engine.launcher.a2ml.
...
APP_NAME="enaction-engine"
APP_DISPLAY="Enaction Engine"
APP_DESC="Deterministic type-safe game engine"
APP_CATEGORIES="Game;Development;"
APP_GENERIC_NAME="Enaction Engine"
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/enaction-engine/enaction-engine.launcher.a2ml"

URL=""


PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/enaction-engine.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/enaction-engine/enaction-engine.log"

# Search list from [runtime].startup-command-search — first executable wins.
START_COMMAND=""
for candidate in \
    "/target/release/enaction-engine" \
    "/enaction-engine" \
    "enaction-engine" \
    ; do
    if [ -x "$candidate" ]; then
...
[runtime].startup-command-search or [runtime].command in enaction-engine.launcher.a2ml."
            return 1
        fi
    fi
